...
```{r top 10 songs of all time? I think}
...
```
```{r what distinct date did the oldest song leave the charts?}
...
```{r What songs could have been played at your 16th birthday party?}
